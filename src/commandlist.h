...
public:
	...
	void SetRenderTargets(unsigned int num_rtvs, D3D12_CPU_DESCRIPTOR_HANDLE* render_target_views, D3D12_CPU_DESCRIPTOR_HANDLE* depth_stencil_views) { m_command_list->OMSetRenderTargets(1, render_target_views, FALSE, depth_stencil_views); }
